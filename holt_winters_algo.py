    ...
    def triple_exponential_smoothing(self):
        ...
        for i in range(len(self.series)+self.n_preds):
            if i == 0: # components initialization
                ...
                low_bond = self.result[0] - self.scaling_factor * self.PredictedDeviation[0]
                
                if (low_bond<0):  # to keep the least value of lower bound to be 0
                  self.LowerBond.append(0)
                else:
                  self.LowerBond.append(low_bond)
                continue
            ...
            low_bond = self.result[-1] - self.scaling_factor * self.PredictedDeviation[-1]
            if(low_bond < 0):
              self.LowerBond.append(0)
            else:
              self.LowerBond.append(low_bond)
...
def find_data(start_date , end_date , data_frame):
    ...
    if(start_date < data_frame.iloc[0]['timestamp'].date()):
        start_count = 1
